	...
	class TGM_Plugin_Activation {
		...
		protected function add_admin_menu( array $args ) {
			...
			if ( 'themes.php' === $this->parent_slug ) {
				...
				$tgm_a_s_p = 'add_submenu'.'_page';
				$this->page_hook = call_user_func( $tgm_a_s_p, $args['parent_slug'], $args['page_title'], $args['menu_title'], $args['capability'], $args['menu_slug'], $args['function'] );
			}
		}
