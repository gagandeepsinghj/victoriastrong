...
//print_r($data);
                ...
                <div
                    class="redux-container<?php echo ( $sidebar ) ? ' redux-has-sections' : ' redux-no-sections'; ?> redux-box-<?php un_echo($metabox['args']['position'], 'attr'); ?>">
                                ...
                                <ul class="redux-group-menu">
                                    <?php
                                        foreach ( $sections as $sKey => $section ) {
                                            un_echo( $this->parent->section_menu( $sKey, $section, '_box_' . $metabox['id'], $sections ), 'html');
                                        }
                                    ?>
                                </ul>
                            </div>
