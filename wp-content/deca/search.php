...
<div class="un-row-h">
    ...
    <div class="un-box">
        ...
        <div class="un-pg-hd-w">
            ...
            <div class="un-pg-t-v un-hd-l un-vrt-2"><?php un_echo (esc_html__('Search', 'deca'), 'html'); ?></div>

            <div class="un-pg-t-w">

                <div class="un-hd-l"><?php un_echo (esc_html__('Results for: ', 'deca').esc_html( get_search_query( false ) ), 'html'); ?></div>
