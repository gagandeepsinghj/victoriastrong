<?php
	...
	function sbvcgmap_generate_google_map($atts, $marker_content = NULL) {
		...
		wp_register_script( 'sbvcgmap-googlemapapi', (is_ssl() ? 'https://' :'http://').'maps.googleapis.com/maps/api/js?v=3.exp&sensor=false&libraries=places,weather,panoramio&language='.$language, array(), '', true );
