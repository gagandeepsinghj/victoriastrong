...
<?php if( ( (is_page() || is_single() ) && redux_post_meta(UN, get_the_ID(), 'meta-footer-widgets') == 1 ) || un_is_woocommerce() ) { ?>
    ...
    <div class="un-hr-b">
        ...
        <div class="un-box un-pos-r">
            ...
            <div class="un-get-t">
                ...
                <?php if( un_redux_opt(UN, 'opt-footer-copy') ){ ?>

                    <span class="un-rights"><?php un_echo( un_redux_opt(UN, 'opt-footer-copy'), 'html' ); ?></span>
