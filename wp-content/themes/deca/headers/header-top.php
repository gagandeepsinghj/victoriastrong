...
<?php $head_style = ''; $head_pos = '';

$head_pos = un_redux_opt(UN, 'opt-header-top-sticky');

if ( $head_pos == 'sticky' ) {
	
	$head_pos_class = ' un-head-fixed';
	
} else {
		
	$head_pos_class = ' un-head-abs';
...
<div class="un-hr-top <?php un_echo( $head_style, 'attr' ); un_echo( $head_pos_class, 'attr' ); ?>">
