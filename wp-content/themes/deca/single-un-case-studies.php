<?php
/*
Description: Visual Composer Single Case
Theme: DECA
*/
?>
...
if ( un_redux_opt(UN, 'opt-posttypes-cases-related') == true ) {

	// Related Cases
	
	$args = un_related_posts_query_args( get_the_ID(), 'un-case-categories', 3 );
	...
	<div class="un-box">
		...
		<div class="un-rel-w-w">
			...
			<h4 class="un-rel-w-t"><?php esc_html_e('Similar Cases', 'deca'); ?></h4>
